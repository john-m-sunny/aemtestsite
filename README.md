...
## Environments
- Preview: https://main--aemtestsite--john-m-sunny.aem.page/
- Live: https://main--aemtestsite--john-m-sunny.aem.live/
...
1. Open the `aemtestsite` directory in your favorite IDE and start coding :)
